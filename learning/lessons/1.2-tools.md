# ⚠️ DEPRECATED: Lesson 1.2 - File Operations Tooling

**Status:** Part of OLD automated system (2024-12-14)
**Deprecated:** 2024-12-16 (Pivot to Interactive Partner)
**See instead:** `phase1-reboot.md` for file-based tools (no session state)
**Why kept:** Historical reference - tool patterns still valid, session state abandoned
...
# In blogger/tools.py
CURRENT_DIR = Path(__file__).parent  # → .../blogger/
PROJECT_ROOT = CURRENT_DIR.parent     # → .../ai-blog-partner/
